...
def get_spend_logs_id(call_type: str, response_obj: dict, kwargs: dict) -> Optional[str]:
    if call_type == "aretrieve_batch" or call_type == "acreate_file":
        ...
        call_id = cast(str | None, kwargs.get("litellm_call_id"))  # cast-ok: kwargs is an untyped dict
        id = call_id or cast(str | None, response_obj.get("id"))  # cast-ok: response_obj is an untyped dict
    else:
